            ...
            <div>
                ...
                <div class="content-area active">
                    <div class="names">
                        ...
                        <div class="flex-area">
                            <input type="text" placeholder="Vul deelnemer 1 in"><button>x</button>
                        </div>
                    </div>
                    <div class="names">
                        ...
                        <div class="flex-area">
                            <input type="text" placeholder="Vul deelnemer 2 in"><button>x</button>                        
                        </div>
                        <div class="flex-area">
                            <input type="text" placeholder="Vul deelnemer 3 in"><button>x</button>                        
                        </div>
                        <div class="flex-area">
                            <input type="text" placeholder="Vul deelnemer 4 in"><button>x</button>                        
                        </div>
                        <div class="flex-area">
                            <input type="text" placeholder="Vul deelnemer 5 in"><button>x</button>                        
                        </div>
